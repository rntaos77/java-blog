...
public class ArticleService extends Service {
	...
	public Map<String, Object> getCheckRsDeleteAvailable(Article article, int actorId) {
	...
	public List<ArticleReply> getForPrintArticleReplies(int articleId, int actorId) {
		...
		for(ArticleReply articleReply : articleReplies) {
			updateArticleExtraDataForPrint(articleReply, actorId);
			
		}
		return articleReplies;
	}
	private void updateArticleExtraDataForPrint(ArticleReply articleReply, int actorId) {
